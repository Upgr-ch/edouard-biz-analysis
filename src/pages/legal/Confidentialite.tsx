...
const Confidentialite = () => (
  <LegalLayout title="Politique de Confidentialité">
    ...
    <p>La présente Politique de Confidentialité décrit comment l'application Édouard, éditée par Kévin Lavergne – UpGrade, collecte, utilise, protège et partage vos données personnelles conformément à la Loi fédérale sur la protection des données (LPD) et, si applicable, au Règlement général sur la protection des données (RGPD).</p>
    ...
    <ul>
      ...
      <li><strong>Données techniques :</strong> type d'appareil, version du système, adresse IP (si applicable).</li>
    </ul>
    ...
    <p>Les données sont conservées le temps nécessaire aux finalités pour lesquelles elles ont été collectées ou dans le respect des durées légales applicables.</p>
    ...
    <p>Cette politique peut être mise à jour à tout moment. La version la plus récente est toujours accessible dans les paramètres de l'application.</p>
  </LegalLayout>
);
